...
- (void)viewDidLoad {
    ...
    self.progressView = [[UIProgressView alloc] initWithFrame:CGRectMake(0, 44 ,self.view.frame.size.width, 0.5)];
...
- (WKWebView *)wkWebView {
    if (!_wkWebView) {
        _wkWebView = [[WKWebView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height) configuration:self.wkConfig];
